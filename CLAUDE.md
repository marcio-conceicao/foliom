...
**Core Value:** **Cold start rápido e baixo uso de memória mesmo em grafos grandes, sem injetar metadados nos arquivos `.md`.** Essa é a dor primária que mata a experiência do Logseq hoje — se Foliom não resolver isso, não tem razão de existir.
